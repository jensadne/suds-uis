...
long_description = """
---------------------------------------
Lightweight SOAP client (Unicornis fork).
---------------------------------------
...
package_name = "suds-uis"
version_tag = pkg_resources.safe_version(__version__)
project_url = "https://github.com/unicornis/suds-uis"
...
setup(
    name=package_name,
    version=__version__,
    description="Lightweight SOAP client (Unicornis fork)",
    ...
    maintainer="Eirik W. Talberg",
    maintainer_email="eirik@unicornis.no",
